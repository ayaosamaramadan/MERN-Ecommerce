      ...
      >
        ...
        <div>
          ...
          <div className="flex border-b-[0.2rem] pb-4">
            <div className="pr-2">
            <img src="https://res.cloudinary.com/dgjbaeyok/image/upload/v1741045606/cdqjcyixdpodrdvi0mtz.png" alt="" />
            </div>
            <div>
              <p className="font-semibold">Free Delivery</p>
              <p className="underline text-[0.9rem]">Enter your postal code for Delivery Availability</p>
            </div>
          </div>
          <div className="flex pt-4">
          <div className="pr-2">
            <img src="https://res.cloudinary.com/dgjbaeyok/image/upload/v1741045606/mstatpxvwndmk3tajxux.png" alt="" />
            </div>
            <div >
              <p className="font-semibold">Return Delivery</p>
              <p className="text-[0.9rem]">Free 30 Days Delivery Returns. Details</p>
            </div>
          </div>
          </div>
        </div>
                ...
                <div>
                  <div className="flex">
                    <img
                      ...
                      alt=""
                                  />
                    <p className="ml-5 text-[1.2rem] text-red-500 mt-2">Related Item</p>
                  </div>
                </div>
