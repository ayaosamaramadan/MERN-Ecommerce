...
import { updateUserName, updateUserEmail, updateUserPass } from "../../reducers/auth"; 
...
const Account = () => {
  ...
  const handleProfileUpdate = async () => {
    ...
    try {
      await axios.put(
        "https://ecommerce-server-coral-mu.vercel.app/api/users/updateProfile",
  ...
  return (
    <div className="2xl:mt-52 xl:mt-52 lg:mt-52 md:mt-64 mr-0 2sm:mt-64 sm:mt-64 2xl:ml-20 xl:ml-20 xl:mr-20 lg:ml-20 md:ml-20 sm:ml-10 2sm:ml-10">
      ...
      <h1 className="text-red-500 text-xl font-semibold mb-5">Edit Your Profile</h1>
      ...
      <div className="flex justify-end mr-4 sm:mr-16 mt-5">
       <button type="button" className=" mr-2 hover:bg-slate-200 text-black px-4 py-2 rounded-md">Cancel</button>
       <button
      type="button"
