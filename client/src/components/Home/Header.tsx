...
const Header = () => {
  return (
    <>
      <div className="flex">
        <div className="2xl:block xl:block lg:block md:hidden border-r-2 border-black-100 w-[280px] pr-20">
        ...
        <div className="ml-[10%] mr-[10%] 2xl:mt-[5%] xl:mt-[5%] lg:mt-[5%] md:mt-[12%] sm:mt-[12%] 2sm:mt-[12%]">
